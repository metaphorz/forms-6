...
These tools are pure client-side computations (no precompute). Gaussian-process
regression with automatic-relevance-determination length scales and a small
neural network, together with variance-based total/interaction indices and
grid-point-level sensitivity, are the planned next step.
